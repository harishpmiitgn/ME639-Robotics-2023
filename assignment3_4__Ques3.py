# -*- coding: utf-8 -*-
"""Assignment3_4__Ques3.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1GGjcVeGeG_cnzHu7PGEJkgBSjYNJmblF

IF Joint type is not given: Consider RRR
"""
...
Jacobian_Matrix = Jacobian(DHparameters)
end_effector_pos = end_effector_position(DHparameters)
...
"""If all joints are not revolute. ( Takinng joint type as an input )"""
...
def joint_velocities(J, X_dot):
    ...
    q = np.dot(np.linalg.pinv(J), X_dot)  # joint velocity = Jinverse * Endeffector velocity
    return q


# Example usage
Nature_of_joint = ["R", "P", "P", "R"]
DHparameters = [
    [0, 1, 0, 0],
    [-np.pi/2, 1, 0, -np.pi/2],
    [-np.pi/2, 1, 0, -np.pi/2],
