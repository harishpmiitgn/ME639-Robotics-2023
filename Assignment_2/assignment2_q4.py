# -*- coding: utf-8 -*-
"""Assignment2_Q4.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1H_6YxlbZGOypB7uRsZMaAlFgYeWJlutZ
"""
...
def forward_kinematics(theta1, theta2, d3):
    T01 = rot_z(theta1)
    T12 = rot_x(np.pi/2) @ rot_z(theta2) @ trans_z(a1)
    T23 = trans_x(a2+d3)
    P3 = trans_x(a3)
...
d3 = 0.2  # Extension + link length 3 in meters
