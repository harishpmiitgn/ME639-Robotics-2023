...
l3=float(input("enter minimum definite length extension of prismatic joint "))
...
H12=getH(np.matmul([[0, 0, 1],[0, 1, 0],[-1, 0, 0]], getR(q2)), [[0],[0],[l1]])
H23=getH(getR(0), [[0],[l2+l3],[0]])
P=np.linalg.multi_dot([H01,H12,H23,[[0],[d],[0],[1]]])
