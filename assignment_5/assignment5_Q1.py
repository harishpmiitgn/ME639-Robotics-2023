...
y = 0.9     # Desired end-effector y-coordinate
z = 1.0     # Desired end-effector z-coordinate
print(f"Sample values taken for Stanford manipulator: \nLink lengths: {link1},{link2},{link3} \nDesired coordinates: {x},{y},{z}\n")
theta1, theta2, d3 = inverse_kinematics_RRP(link1, link2, link3, x, y, z)
print("Results from Inverse kinematics of Stanford manipulator")
...
print("Results from Forward kinematics of Stanford manipulator")
